...
export class DifficultyAttributes {
    ...
    toJSON() {
        return {
            ...
            readingDifficulty: this.readingDifficulty,
            readingDifficultNoteCount: this.readingDifficultNoteCount,
     ...
     * @returns {number | undefined}
     */
    get readingDifficulty() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_difficultyattributes_readingDifficulty(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r2 = getDataViewMemory0().getFloat64(retptr + 8 * 1, true);
            return r0 === 0 ? undefined : r2;
        } finally {
     ...
     * @returns {number | undefined}
     */
    get readingDifficultNoteCount() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_difficultyattributes_readingDifficultNoteCount(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r2 = getDataViewMemory0().getFloat64(retptr + 8 * 1, true);
            return r0 === 0 ? undefined : r2;
        } finally {
...
export class PerformanceAttributes {
    ...
    get ppReading() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_performanceattributes_ppReading(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r2 = getDataViewMemory0().getFloat64(retptr + 8 * 1, true);
            return r0 === 0 ? undefined : r2;
        } finally {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getwithrefkey_86f8964034aaee9b = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_set_b055cf1115e4f138 = function(arg0, arg1, arg2) {
